      ...
      <li class="exercise-card" data-id="${exercise._id}">
        <div class="exercise-card-header">
          ...
          <div class="exercise-rating">
            <span class="exercise-rating-value">${exercise.rating.toFixed(1)}</span>
        ...
        <div class="exercise-card-body">
          ...
          <ul class="exercise-card-info">
            <li class="exercise-card-info-item">
              ...
              <span class="exercise-card-info-value">${exercise.burnedCalories} / 3 min</span>
            </li>
            <li class="exercise-card-info-item">
              <span class="exercise-card-info-label">Body part:</span>
              <span class="exercise-card-info-value">${exercise.bodyPart}</span>
            </li>
            <li class="exercise-card-info-item">
              <span class="exercise-card-info-label">Target:</span>
              <span class="exercise-card-info-value">${exercise.target}</span>
            </li>
          </ul>
        </div>
